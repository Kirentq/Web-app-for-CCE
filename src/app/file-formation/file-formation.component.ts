...
@Component({
  selector: 'app-file-formation',
  templateUrl: './file-formation.component.html',
  styleUrls: ['./file-formation.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class FileFormationComponent implements OnInit {
  curr_id = -1;
  httpOptions = {
  ...
  addCurrency(){
    ...
    newdiv.innerHTML = `
      ...
      <div class="headers"><span>Диапазон</span><span>Покупка</span><span>Продажа</span><span></span></div>
